...
public class quick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            Toast.makeText(this, e.toString()+" main", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void keyboard(String a) {
        try {
            ...
            Toast.makeText(this, e.toString()+" keyboard", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void checkfinish() {
        try {
            ...
            Toast.makeText(this, e.toString()+" checkfinish", Toast.LENGTH_LONG).show();
        }
    }
}